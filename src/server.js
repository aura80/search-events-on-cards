...
const app = express();
const PORT = 3000; // Sau alt port dacă 3000 este ocupat
const API_KEY = "PGvnw7R39KdJOdgwdwYIUxNYPmXcTUQi"; // Cheia ta API
...
app.use(cors());
app.use("/images", express.static(path.join(__dirname, "..", "images"))); // Servește fișierele din 'images'
app.use(express.static(path.join(__dirname, "..", "src"))); // Servește fișierele statice din 'src'
